...
def free_bacon(score):
    ...
    "*** YOUR CODE HERE ***"
    # k+3 points
    # k is the nth digit of pi after the decimal point
    # n is the opponent's score
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if increment > running_high:
            print(increment, "point(s)! The most yet for Player", who)
        return announce_highest(who, score, max(running_high, increment))
    return say
    # END PROBLEM 7
