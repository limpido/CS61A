...
def insert(link, value, index):
    ...
    if index == 0:
        ...
        this creates a new instance and assign it to the `link` in the insert frame,
        the `link` in the global frame still points to the original instance
        and has not been mutated

        > link.rest = link
        causes a loop in the linked list
        """
