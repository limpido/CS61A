...
def pingpong(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper(i, res, increment):
        if i == n:
            return res
        elif i % 8 == 0 or num_eights(i) > 0:
            return helper(i+1, res-increment, -increment)
        else:
            return helper(i+1, res+increment, increment)
    return helper(1, 1, 1)
...
def missing_digits(n):
    ...
    if n < 10:
        ...
        return max(last - all_but_last % 10 - 1, 0) + missing_digits(all_but_last)
...
def count_coins(total):
    ...
    def count(total, coin):
        ...
        if coin == None:
            ...
            without_coin = count(total, next_largest_coin(coin))
